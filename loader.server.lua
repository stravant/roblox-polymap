...
if COMBINE_TOOLBAR then
	...
	local toolbar = plugin:CreateToolbar("PolyMap")
	local button = toolbar:CreateButton("openPolyMap", TOOLTIP, RIBBON_ICON, "PolyMap")
...
local panel = plugin:CreateDockWidgetPluginGuiAsync("PolyMapPanel", params)
